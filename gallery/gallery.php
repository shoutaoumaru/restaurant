...
<body>
  <div class="superwrapper animsition">
    ...
    <!-- /#header -->
    <div class="gal-top">
      <div class="gal-top__wrapper">
        <div class="gal-top__img">
        ...
        <h3 class="c-txt-md">Inside the store</h3>
      </div>
    </div>
    <!-- /.gal-top -->
    <section class="gal-contents">
      <div class="gal-contents__container">
        <div class="gal-contents__list appear up">
          <div class="gal-contents__item item">
            <img class="gal-contents__img" src="<?php echo get_template_directory_uri(); ?>/images/home/caffe_staff.jpg" alt="">
            <div class="gal-contents__txtarea">
              <p class="gal-contents__txt">
                Our Staff
              </p>
            </div>
          </div>
          <div class="gal-contents__item item">
            <img class="gal-contents__img" src="<?php echo get_template_directory_uri(); ?>/images/home/cooking.jpg" alt="">
            <div class="gal-contents__txtarea">
              <p class="gal-contents__txt">
                Our Cooking
              </p>
          ...
          <div class="gal-contents__item item">
            <img class="gal-contents__img" src="<?php echo get_template_directory_uri(); ?>/images/home/steak_2@pc.jpg" alt="">
            <div class="gal-contents__txtarea">
              <p class="gal-contents__txt">
                Aige Beef
              </p>
          ...
          <div class="gal-contents__item item">
            <img class="gal-contents__img" src="<?php echo get_template_directory_uri(); ?>/images/home/sushi_1@pc.jpg" alt="">
            <div class="gal-contents__txtarea">
              <p class="gal-contents__txt">
                Sushi
              </p>
