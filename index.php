  ...
  <div class="superwrapper">
      ...
      <div class="c-container">
        <div class="c-img01">
          ...
          <div class="p-concept__img">
            <img class="parallax" src="<?php echo get_template_directory_uri(); ?>/images/home/sushi_2@pc.jpg" alt="">
          </div>
        </div>
        <div class="c-txtarea parallax-up">
          <p class="ja">90日熟成の神戸ビーフ、朝採れ野菜、地物の新鮮な魚介。とことん厳選した素材にこだわり、極上な「食の体験」をお手軽に。
          </p>
          <a class="more-link animsition-link" href="/concept/"><span class="readmore">Read
              More</span></a>
        </div>
      </div>
    </section>
    ...
    <section id="gallery" class="p-gallery">
      <div class="c-container appear up">
        ...
        <a class="more-link animsition-link item" href="/gallery/"><span class="readmore">Read
            More</span></a>
      </div>
    </section>
    <!-- /#gallery -->
      ...
      <div class="c-container">
        <div class="c-img01">
          ...
          <div class="p-menu__img">
            <img class="parallax" src="<?php echo get_template_directory_uri(); ?>/images/home/steak_1@pc.jpg" alt="">
          </div>
        </div>
        <div class="c-txtarea parallax-up">
          <p class="ja">食の感動体験をテーマに、水々しい朝採れ野菜、90日熟成の神戸ビーフ、厳選した魚介をご提供します。
          </p>
          <a class="more-link animsition-link" href="/menu/"><span class="readmore">Read More</span></a>
        </div>
      </div>
    </section>
    <!-- /#menu -->
      ...
      <div class="c-container appear up">
        <div class="c-img01">
          ...
          <div class="p-access__img">
            <img class="parallax" src="<?php echo get_template_directory_uri(); ?>/images/home/store_3@sp.jpg" alt="">
          </div>
        </div>
        <div class="c-txtarea parallax-up">
          <p class="ja">博多駅からアクセスのよく自然の調和も感じる感じる素敵な場所。
          </p>
          <a class="more-link animsition-link" href="/access"><span class="readmore">Read More</span></a>
        </div>
      </div>
    </section>
    <!-- /#access -->
    <section id="news" class="p-news">
      <div class="c-container appear up">
          ...
          <?php if(have_posts()) : while(have_posts()) : the_post(); ?>
            <li class="p-news__item">
              <a href="<?php the_permalink(); ?>" class="p-news__link">
                <?php the_post_thumbnail('thumbnail'); ?><span class="p-news__date"><?php echo get_the_date(); ?></span>
        ...
        <a class="more-link animsition-link item" href="/news"><span class="readmore">Read More</span></a>
      </div>
    </section>
    <!-- /#news -->
    <footer class="footer">
